function varargout = do_locally_cached_calc(local_cache_dir,function_name,varargin)
...
if ~exist('dir_of_caches.m','file')
    ...
    if strcmp(cached_dir,'null')
        ...
        to_eval = [to_eval 'do_locally_cached_calc_checksum_known(local_cache_dir,function_name,the_checksum'];
        for jj = 1:(nargin-2)
            to_eval = [to_eval ',varargin{' num2str(jj) '}'];
        end
        to_eval = [to_eval ');'];
