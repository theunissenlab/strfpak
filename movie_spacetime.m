function varargout = movie_spacetime(varargin)
% MOVIE_SPACETIME Application M-file for songwave_specgram.fig
%    FIG = MOVIE_SPACETIME launch songwave_specgram GUI.
%    MOVIE_SPACETIME('callback_name', ...) invoke the named callback.
...
add_to_STRFPAK_script('movie_spacetime.m','preprocess');
