function varargout = movie_spacetime_pred(varargin)
% MOVIE_SPACETIME_PRED Application M-file for songwave_specgram.fig
%    FIG = MOVIE_SPACETIME_PRED launch songwave_specgram GUI.
%    MOVIE_SPACETIME_PRED('callback_name', ...) invoke the named callback.
...
tempWait = waitbar(0,...
     sprintf('Preprocessing 2-D movie data...'));
for ii=1:numfiles
