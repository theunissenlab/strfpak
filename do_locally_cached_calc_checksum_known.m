function varargout = do_locally_cached_calc_checksum_known(local_cache_dir,function_name,the_checksum,varargin)
...
if strcmp(cached_dir,'null')
    ...
    if ~exist(cached_dir,'dir')
        disp(['Message from function "do_locally_cached_calc_checksum_known": making cache directory "' cached_dir '".']);
